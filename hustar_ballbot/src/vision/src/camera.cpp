...
const float WHRatio       = (float)inWidth / (float)inHeight;
const float inScaleFactor = 0.007843f;
const float meanVal       = 127.5;
const char* classNames[]  = {"tennis"};
...
int main(int argc, char** argv) try
{
    ...
    String yoloModel ="/home/piai/catkin_ws_d435i/src/ROS_realsense_opencv_tutorial/data/yolov4_best.weights";//yolov4.weights enetb0-coco_final.weights
    String yoloCfg =  "/home/piai/catkin_ws_d435i/src/ROS_realsense_opencv_tutorial/data/yolov4.cfg";//yolov4.cfg enet-coco.cfg
